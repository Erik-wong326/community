...
public class ElasticsearchTests {
    ...
    public void testInsertList() {
        ...
        discussRepository.saveAll(discussMapper.selectDiscussPost(149, 0, 100,0));
        discussRepository.saveAll(discussMapper.selectDiscussPost(145, 0, 100,0));
        discussRepository.saveAll(discussMapper.selectDiscussPost(161, 0, 100,0));
    }
